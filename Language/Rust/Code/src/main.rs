...
fn main() {
    ...
    println!("Hello, world!");
    let mut riyad_account = BankAccount::new("RYD_12312".to_string(), "Riyad_Karim".to_string());

    let mut karim_account = BankAccount::new("krm_10010".to_string(), "karim".to_string());
    ...
    let new_phone_number = karim_account
        .phone_number
        .unwrap_or("Default phone number".to_string());
    println!(
        "This will get phone number or return from here {}",
        new_phone_number
    );
    ...
    // let phone_number = &riyad_account
    //     .phone_number
    //     .unwrap_or("01712345678".to_string());
